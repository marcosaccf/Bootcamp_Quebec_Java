...
//        for (String numerosAleatorio : numerosAleatorios) {
...
//                .forEach(System.out::println);
        ...
        List<Integer> numerosAleatoriosInteger = new ArrayList<>(List.of(1, 0, 4, 1, 2, 3, 9, 9, 6, 5));
...
//        Para você
        ...
        List<Integer> numerosOrdemNatural = numerosAleatorios1.stream()
                .sorted(Comparator.naturalOrder())
                .collect(Collectors.toList());
        System.out.println(numerosOrdemNatural);

        System.out.println("Agrupe os valores ímpares múltiplos de 3 ou de 5:");
        Map<Boolean, List<Integer>> collectNumerosMultiplosDe3E5 = numerosAleatorios1.stream()
